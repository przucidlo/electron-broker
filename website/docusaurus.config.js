...
const config = {
  ...
  themeConfig:
    ...
    ({
      navbar: {
        title: 'ElectronBroker',
        logo: {
          alt: 'ElectronBroker logo',
          src: 'img/logo.svg',
        },
        items: [
          {
          ...
          {
            href: 'https://github.com/abbl/electron-broker',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} ElectronBroker, Built with Docusaurus.`,
      },
      prism: {
