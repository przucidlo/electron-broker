import { ExecutionContext, TransformableDoveClient } from '../../../lib';
...
describe('TransformableDoveClient', () => {
  let transformableClient: TransformableDoveClient;
  ...
  beforeEach(() => {
    ...
    transformableClient = new TransformableDoveClient(
      ipcTransport,
